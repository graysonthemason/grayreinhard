...
export var SERVICES: Service[] = [
	{
		...
		"navlist": [
		{
			...
			<p>&nbsp;&nbsp;&nbsp;&nbsp;In his spare time, Gray also helps students at General Assembly as part of their mentorship program and loves building web-based games like this one (<a href="https://make7.herokuapp.com/" target="_blank">Make 7</a>).
			</p>`
		}, 
		{
			"label": "clients",
